...
\begin{figure}[htb]
\centering
\includegraphics[height=0.5\textwidth]{CH4-F1-EP}
...
%the systems overview that requires further clarification should be referred
% back to the developer's official web site.
...
\ep~systems from the \LLLs perspective is required.
