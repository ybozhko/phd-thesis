...
cannot read them which results in poor accessibility.
...
not present in other systems. Among these were:
\begin{itemize}
...
\centering
	...
	form of comments, message board and internal message system & 
	-- Groups are used for collaboration; \newline -- Communication is
	in form of comments, wall messages and internal message system & 
	...
	separate form of the artifacts & 
	Individual items can have multiple reflections & 
	Reflection in form of blogs & 
	Reflection in form of blogs & 
...
analysis should not be considered complete and final. As it was explained, the
