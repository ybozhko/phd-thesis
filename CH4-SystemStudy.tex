...
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[width=0.8\textwidth]{CH4-F5-ELGG}}
...
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[width=0.8\textwidth]{CH4-F6-BB}}
...
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[width=0.8\textwidth]{CH4-F7-D2L}}
...
There is a standard range of functionality associated with artifacts: they can
...
% The approach suggested by this project provides rich integration between LMS and
% ePortfolio systems with an opportunity of smart data flow, resolving
% confidentiality and ethics issues, involving feedback from the outside of the
% institutional environment, and tracking long-term and short-term progress. This
% leaves space for formal education as well as for non-formal types of learning,
% enriching the overall personal learning experience.
