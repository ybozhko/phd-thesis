...
development of these features would exceed the benefit that would be gained from
them by the users.
...
\begin{itemize}
  ...
  \item Advanced sharing options -- for addressing the issues of guidance and
  facilitation from non-institutional audiences, providing learners with better
...
Figure \ref{fig:frag} shows the way of extracting fragments for different file
types and \ep~artifacts.

\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{CH6-F5-Fragments}
