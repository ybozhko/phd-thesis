...
\begin{center} \small
    ...
    \tabletail{
     ...
     \hline}
    \tablelasttail{\hline}
	\bottomcaption{Implemented requirements for version control elements}
    \begin{supertabular}{|l p{10cm}|}
     1 & Be able to create new version of the page \\ \hline
     2.1 & Be able to delete any version of the page  \\ \hline
     2.2 & Delete all versions if the page is deleted completely \\ \hline
...
\begin{center} \small
    ...
    \tabletail{
     ...
     \hline}
    \tablelasttail{\hline}
	\bottomcaption{Implemented requirements for concept mapping module}
    \begin{supertabular}{|l p{10cm}|}
...
\begin{center} \small
    ...
    \tabletail{
     ...
     \hline}
    \tablelasttail{\hline}
	\bottomcaption{Implemented requirements for artifacts' fragments extraction}
    \begin{supertabular}{|l p{10cm}|}
     G1 & Text \\ \hline
     G2 & Text  \\ \hline
     G3 & Text  \\ \hline
...
\begin{center} \small
    ...
    \tabletail{
     ...
     \hline}
    \tablelasttail{\hline}
	\bottomcaption{Implemented requirements for progress tracking}
    \begin{supertabular}{|l p{10cm}|}
     G1 & Text \\ \hline
     G2 & Text  \\ \hline
     G3 & Text  \\ \hline
...
\begin{center} \small
    ...
    \tabletail{
     ...
     \hline}
    \tablelasttail{\hline}
	\bottomcaption{Implemented requirements for advanced sharing options}
    \begin{supertabular}{|l p{10cm}|}
     G1 & Text \\ \hline
     G2 & Text  \\ \hline
     G3 & Text  \\ \hline
