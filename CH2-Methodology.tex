...
\note{Do I need to write more about cases selection process, sample size, etc.,
or should it go to the actual evaluation chapter?} 
...
It is not lileky that a single evaluation technique can establish effectiveness
...
\note{Not sure what can be considered a limitation. The list contains only the
ones I could think of\ldots}%
...
the project aimed tno integrated Moodle LMS and ELGG platform. This integration
...
concept of \LLLs and the requirements for its effifcient support. It will
provide a background for the further theory development of this research.
