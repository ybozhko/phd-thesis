...
\fbox{\includegraphics[width=0.7\textwidth]{CH7-F10-Example2}}
...
said that this feature can be used for splitting up artifacts into different
examples to be presented in the concept map.

From the perspective of their field, Participant Two understood the difficulties
of marking up or selecting fragments of the documents that had proprietary
format. However, they said that there could be an choice for users to open a
document as a plain text file for fragment selection. Users generally know
whether their document can be open in plan text format. This would be very
useful for the students in technical areas, such as Participant's Two, where a
lot of skills are demonstrated in programming and code samples.
...
feature was useful for discovering gaps in their learning.
...
According to Participant Two, \textit{The timeline functionality is an
excellent way of viewing progress. It enables the view of what I have done and
then I can also see areas for improvement.}
...
\shortquote{In the concept map, someone can see how I understand the knowledge
concepts, while in timeline I can easily show what I have actually done to
address these concepts [\ldots] If I was teaching now, I would definitely use it
with my students.}
...
\textit{Everything in \ep~should be done with versions. It might be my Computer
Science background, but for me it's a really good way of own seeing progress.}

Participant Three \textit{I think adding version control elements to the
\ep~system may be an excellent idea, though it requires significant work by both
the student and the teacher. It would be useful in many circumstances to view
...
the participants could properly test the features for the shared resources
management. Participant One found the way out by registering another account and
sharing resources between the two accounts. Other participants followed the
descriptions in the user manual and looked at the feature's set ups without
actually sharing resources with anyone. In some cases, they tried out giving
...
in place that allowed sharing resources. However, the valuable benefit of the
\ep~system prototype would potentially be in combination of sharing with the
elements of version control in order to also manage changes and feedback at the
same time.
...
Improvements:
I would like to be able to reorganize concept maps manually. It is just another
level of control.

I would recommend more improvements on the conceptual mapping tool, better
interaction, more tools to order and organise the concepts.
 
\section{Summary}

This section presented the evaluation design and the results of the evaluation
of this research project's contributions.

Rather unexpected outcome of the evaluation was in the fact that it was very
difficult for the participants to give their opinion of the underlying concepts
without paying attention to the user interface. The evaluated system was a
functional prototype and therefore was not aiming at providing highly attractive
and usable user interface. However, this problem should be considered in any
future research.
