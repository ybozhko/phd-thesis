...
\begin{center}
    \tablefirsthead{
     \hline
     \multicolumn{1}{|c|}{\textbf{\LLLc Guidelines}} &
     \multicolumn{1}{c|}{\textbf{Potential \ep~System Features}} \\
     \hline}
    \tablehead{
     \hline
...
These requirements were used in the prototype functionality development at the
